...
const classBases = {
  'Pelts': { 'name': 'pelt', 'sockets': 3, 'cost': 'r20' },
  'Barbarian Helm': { 'name': 'phlm', 'sockets': 3, 'cost': 'r22' },
  'Scepter': { 'name': 'scep', 'sockets': 5, 'cost': 'r26' },
  'Wand': { 'name': 'wand', 'sockets': 2, 'cost': 'r20' },
  'Knife': { 'name': 'knfe', 'sockets': 3, 'cost': 'r23' },
  'Scissors': { 'name': 'h2h', 'sockets': 3, 'cost': 'r23' },
  'Staff': { 'name': 'staf', 'sockets': 4, 'cost': 'r24' },
  'Staff 2': { 'name': 'staf', 'sockets': 2, 'cost': 'r19' },
  'Shield 3': { 'name': 'shld', 'sockets': 3, 'cost': 'r27' },
  'Shield 4': { 'name': 'shld', 'sockets': 4, 'cost': 'r25' },
};


if (config.baseMarket) {
for (let i in classBases) {
let item = classBases[i];

  cubemain.rows.push({
    'description': `Socketed ${i}`,
    'enabled': 1,
    'version': 100,
    'numinputs': 4,
    'input 1': `${item.name},low`,
    'input 2': `${item.cost}`,
    'input 3': 'vps',
    'input 4': 'yps',
    'output': 'useitem,nos',
    'mod 1': 'sock',
    'mod 1 min': `${item.sockets}`,
    'mod 1 max': `${item.sockets}`,
    'lvl': 100,
    'ilvl': 100,
    '*eol': 0,
  });
...
const ethBases = {
  'Shield 4 Eth': { 'name': 'shld', 'sockets': 4, 'cost': 'r26' },
};


if (config.baseMarket) {
for (let i in ethBases) {
let item = ethBases[i];
